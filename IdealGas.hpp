...
class IdealGas{
    ...
    inline double solvep(double rho, double rhoE, double U, double V){
        return (gamma-1)*(rhoE - 0.5 * rho*(U*U + V*V));
    }
    ...
    inline double solverhoE(double rho, double p, double U, double V){
