...
class PngWriter {
  ...
  PngWriter(int dumpInterval, const int width, const int height, double *fieldPtr, string varName, Colormap cm){
    nx = width;
    ny = height;
  ...
  PngWriter(int dumpInterval, const int width, const int height, double *fieldPtr, string varName, double valMin, double valMax, Colormap cm){
    nx = width;
    ny = height;
    buffer = new unsigned char[nx*ny][3];
  ...
  PngWriter(int dumpInterval, const int width, const int height, double *fieldPtr, string varName, double valMin, double valMax, double x_min[2], double x_max[2], Colormap cm){
    nx = width;
    ny = height;
    buffer = new unsigned char[nx*ny][3];
